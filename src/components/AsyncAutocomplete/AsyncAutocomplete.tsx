...
>(
  ...
  const moduleMap: ModuleMap<T, FreeSolo> = {
    ...
    //     return productServiceApi.fetchProductServices({
    //       params: {
    ...
    //   },
    //   customData: (response) => {
    //     const data = response.data as FetchProductServicesResponseData;
    //     return {
    //       list: data.data ?? [],
    ...
    //   renderOption: (
    //     props,
    //     option: FetchProductServicesResponseData["data"][number]
    //     // { selected }
    //   ) => {
    //     return [
    //       props,
